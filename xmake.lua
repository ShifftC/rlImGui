...
add_requires("imgui docking", "ok-raylib master")
...
target("rlImGui", function()
    ...
    add_packages("imgui", "ok-raylib", {public = true})

    add_files("rlImGui.cpp")
    add_headerfiles("rlImGui.h", "rlImGuiColors.h", "imgui_impl_raylib.h", "extras/*.h")
    add_includedirs(".", {public = true})
    add_extrafiles("xmake.lua", ".gitignore", "LICENSE", "README.md", "examples/**", "resources/**")
end)
